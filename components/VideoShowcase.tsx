  ...
  return (
    <section className="relative overflow-hidden bg-brand-navy py-20 sm:py-28">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 85% 70% at 0% 0%, rgba(0, 174, 239, 0.18) 0%, rgba(11, 19, 43, 0) 58%)",
        }}
        aria-hidden="true"
      />
      <div
      ...
      <SiteContainer className="relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="font-display text-3xl font-bold uppercase leading-[1.1] tracking-tighter text-white sm:text-4xl lg:text-5xl">
            Watch How We{" "}
            <span className="text-brand-aqua">Scale</span> Your Business
          </h2>
        ...
        <div className="relative mx-auto mt-12 aspect-video max-w-4xl overflow-hidden rounded-xl border border-brand-aqua/30 shadow-2xl">
          <Image
          ...
          >
            <span className="flex h-20 w-20 items-center justify-center rounded-full bg-brand-aqua shadow-xl">
